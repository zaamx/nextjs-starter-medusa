                  ...
                  <div className="px-6 py-4 border-t border-gray-200 space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-lg font-bold text-gray-900">
                        Subtotal <span className="text-xs font-normal text-gray-500">(excl. impuestos)</span>
                      </span>
                      <span className="text-2xl font-extrabold text-gray-900" data-testid="cart-subtotal" data-value={subtotal}>
