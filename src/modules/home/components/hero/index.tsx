        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-32 lg:py-32">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-white sm:text-xl/8">
              Únete a WE NOW y transforma tu vida con productos de bienestar de alta calidad y una oportunidad de negocio que te permite ganar mientras ayudas a otros a mejorar su salud.
            </p>
