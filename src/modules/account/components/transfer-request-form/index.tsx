      ...
      <div className="grid sm:grid-cols-2 items-center gap-x-8 gap-y-4 w-full">
        <div className="flex flex-col gap-y-1">
          ...
          <Text className="text-base-regular text-neutral-500">
            No encuentras la orden que buscas?
            <br /> Conecta una orden a tu cuenta.
          </Text>
        </div>
        <form
          action={formAction}
        ...
        >
          <div className="flex flex-col gap-y-2 w-full">
            <Input className="w-full" name="order_id" placeholder="ID de Orden" />
            <SubmitButton
              variant="secondary"
          ...
          <div className="flex gap-x-2 items-center">
            ...
            <div className="flex flex-col gap-y-1">
              <Text className="text-medim-pl text-neutral-950">
                Transferencia de orden {state.order?.id} solicitada
              </Text>
              <Text className="text-base-regular text-neutral-600">
                Correo de solicitud de transferencia enviado a {state.order?.email}
              </Text>
            </div>
          </div>
          <IconButton
